package com.example.coldstorage.Presentation.FarmersSide.Marketplace
...
fun Marketplace(navController:NavHostController)
    {
        ...
        Column(modifier = Modifier.padding(horizontal = 13.dp , vertical = 25.dp)) {
            Row( horizontalArrangement = Arrangement.SpaceBetween , modifier = Modifier.fillMaxWidth()) {
                Text(text = "Marketplace" , fontSize = 24.sp , fontWeight = FontWeight.SemiBold )
            ...
            Text(text = "Visit Marketplace to see cold stores and add more." , fontWeight = FontWeight.Light)
